    ...
    <div class="o-container">
      <section class="content about">
        ...
        <div class="button-wrap">
          <nuxt-link to="/about" class="c-button">
            View More
          </nuxt-link>
        </div>
      </section>
      <section class="content skill">
        ...
        <div class="skill-wrap">
          ...
          <div class="skill-item">
            ...
            <p>
              Google Analyticsを用いてサイト内分析を行うことができます。
              Google Analyticsだけでは追えないデータはスクレイピングによりデータ収集したり、受注データなどの各種データベースからSQLにより抽出・集計しています。
            </p>
          </div>
          <div class="skill-item">
            <h3 class="head">
        ...
        <div class="button-wrap">
          <nuxt-link to="/skill" class="c-button">
            View More
          </nuxt-link>
        </div>
      </section>
      <section class="content work">
        ...
        <div class="button-wrap">
          <nuxt-link to="/work" class="c-button">
            View More
          </nuxt-link>
        </div>
      </section>
